...
userRouter.get("/:id/onboarding-profile", authorize(["admin", "doctor", "nutritionist"]), getOnboardingProfile);
userRouter.get("/:id/reports/:reportId/url", authorize(["admin", "doctor", "nutritionist"]), getReportSignedUrl);
