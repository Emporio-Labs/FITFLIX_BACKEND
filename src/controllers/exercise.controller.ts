...
// Signing lives in a shared util because several endpoints return exercise
// documents (this catalog, live workout sessions, plan/assignment day details)
// and they must share one presigned-URL cache.
