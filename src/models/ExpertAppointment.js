...
var expertAppointmentSchema = new mongoose_1.default.Schema({
    ...
    timezone: {
        type: String,
        default: function () { var _a; return (_a = process.env.CALID_DEFAULT_TIMEZONE) !== null && _a !== void 0 ? _a : "Asia/Kolkata"; },
    },
...
expertAppointmentSchema.index({ userId: 1, expertType: 1 }, {
    unique: true,
...
expertAppointmentSchema.index({ idempotencyKey: 1 }, { unique: true, sparse: true, name: "expert_appointment_idempotency" });
expertAppointmentSchema.index({ calIdBookingId: 1 }, { sparse: true });
expertAppointmentSchema.index({ userId: 1, bookingStatus: 1 });
exports.default = mongoose_1.default.models
    .ExpertAppointment ||
