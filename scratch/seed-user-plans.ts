...
async function main() {
	try {
		...
		if (!baseFood) {
			console.log(
				"No foods found in catalog. Seeding a system base food item...",
			);
			...
			console.log(
				`Using existing base food: ${baseFood.name} (${baseFood._id})`,
			);
		}
		...
		const buildMeals = () => [
			{
				...
				items: [
					...
					{
						foodId,
						foodName: "Organic Peanut Butter",
						quantityG: 15,
						caloriesKcal: 94,
						proteinG: 3.8,
						carbsG: 3.0,
					...
					{
						foodId,
						foodName: "Unsweetened Almond Milk",
						quantityG: 200,
						caloriesKcal: 30,
						proteinG: 1.0,
						carbsG: 1.0,
			...
			},
			{
				...
				items: [
					...
					{
						foodId,
						foodName: "Organic Green Lettuce",
						quantityG: 80,
						caloriesKcal: 12,
						proteinG: 1.0,
						carbsG: 2.0,
					...
					{
						foodId,
						foodName: "Peri Peri Sauce Dressing",
						quantityG: 15,
						caloriesKcal: 45,
						proteinG: 1.0,
						carbsG: 2.0,
					...
					{
						foodId,
						foodName: "Cold-Pressed Olive Oil",
						quantityG: 10,
						caloriesKcal: 88,
						proteinG: 0.0,
						carbsG: 0.0,
			...
			},
			{
				...
				items: [
					{
						foodId,
						foodName: "Lean Shredded Chicken",
						quantityG: 80,
						caloriesKcal: 132,
						proteinG: 25.0,
						carbsG: 0.0,
					...
					{
						foodId,
						foodName: "Whole Wheat Bread Slices",
						quantityG: 60,
						caloriesKcal: 150,
						proteinG: 6.0,
						carbsG: 28.0,
		...
		for (const u of users) {
			...
			const plan = await UserNutritionPlan.create({
				...
				lifestyleRecommendations: [
					{
						title: "Hydration",
						description: "Drink at least 3.5L water daily.",
						category: "Lifestyle",
					},
					{
						title: "Sleep Adherence",
						description: "Maintain 7-8 hours of deep sleep.",
						category: "Recovery",
					},
				],
			});
			...
			console.log(
				`Successfully assigned active plan "${plan.name}" (Day 3 current) to user "${u.username}" (${u.email})`,
			);
		}
